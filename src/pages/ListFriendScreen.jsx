        ...
        <div className="bg-white rounded-lg shadow">
          ...
          <div className="p-4 flex space-x-2">
            ...
            <div className="relative inline-block text-left">
              <button className="inline-flex justify-center w-full px-4 py-2 text-sm font-medium text-gray-700 bg-white border border-gray-300 rounded-md shadow-sm hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500">
                <span>Tên (A-Z)</span>
          ...
          <div className="overflow-y-auto max-h-96">
            {Object.keys(groupedContacts).sort().map(group => (
              <div key={group}>
                ...
                {groupedContacts[group].map(friend => (
                  <div key={friend._id} className="flex items-center px-4 py-3 border-b hover:bg-gray-50">
                    <div className="flex-shrink-0 h-10 w-10 rounded-full overflow-hidden">
                      <img src={friend.avatar} alt={friend.full_name} className="h-full w-full" />
                    </div>
